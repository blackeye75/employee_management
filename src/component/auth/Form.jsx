  ...
  return (
    <StyledWrapper>
      <div className="form-container">
        ...
        <form className="form">
          <input type="email" className="input bg-transparent text-white" placeholder="Email" />
          <div className="input flex items-center p-0 gap-16 bg-transparent">
            <input type={type} className="outline-none bg-transparent text-white" placeholder="Password" />
